...
class TestParamsToStr:
    def test_returns_string(self):
        from sound_categorisation.cv_utils import params_to_str
...
class TestComputeSeedErrors:
    def test_extracts_errors_and_best(self):
        from sound_categorisation.cv_utils import compute_seed_errors
        data = {'results': [
...
class TestCompareModels:
    def test_be_wins_on_lower_mean(self):
        from sound_categorisation.cv_utils import compare_models

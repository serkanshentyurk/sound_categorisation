"""
Cumulative-Gaussian psychometric fit engine on raw arrays.

``fit_psychometric`` (MLE with lapses, optional trial bootstrap) and
``fit_psychometric_gof``. The session-level readout is

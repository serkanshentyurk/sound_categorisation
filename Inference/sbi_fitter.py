...
#                     params[name] = float(values[0])
#                 else:
#                     params[name] = float(values[s])
...
#     from Inference.summary_stats import compute_summary_stats, flatten_stats
...
#     """
#     from Inference.summary_stats import compute_summary_stats
...
#         """
#         from Inference.summary_stats import get_stat_names_expanded
        
#         samples = result.sample(n_simulations).numpy()
        
#         simulated_stats = np.zeros((n_simulations, len(self.observed_stats)))
#         for i in range(n_simulations):
#             simulated_stats[i] = self.simulator(samples[i], seed=seed + i)
